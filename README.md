...
İngilizce kullanım için yine klasik 2B'lik ve üstü modeller tercih edilebilmektedir.

!! Unutulmamalıdır ki arkada bir Ollama servisi ve Local LLM modeli çalışmadan uygulama işlevsizdir !!
